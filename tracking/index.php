  	...
  	<div id="filter_panel_inner">
        <div class="col">
            ...
            <div class="subcol">
                ...
                <a href="#" data-key="start" data-value="all">All time</a>
                <br>
...
<input type="text" class="text" id="end" value="<?php echo $data->end_date; ?>">
		...
		<select onChange="setSchool(this.value)">
        	<option value="0"> - Select school name - </option>
            <?php
			foreach ($schools as $sid => $sname){
  ...
  <div class="panel">
    ...
    <div class="col3">
    	<div class="colhead">Emails Sent</div>
  ...
  <?php
    ...
    <a style="background-color:#60BD68"></a> Emails sent
  ...
  foreach ($challenges as $index => $challenge) {
		...
		echo isset($bychallange[$index][3]) ? number_format($bychallange[$index][3]) : '';
		
		echo '</td><td align="center">';
		
		echo isset($bychallange[$index][2]) ? number_format($bychallange[$index][2]) : '';
		
		echo '</td></tr>';
		
		// Graph data
		if(!isset($bychallange[$index])) {
			continue;
		}
		
		$avc[] = array(
				'value' => $bychallange[$index][0],
