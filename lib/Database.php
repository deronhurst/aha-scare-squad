...
var $server   = "172.24.16.23"; //database server
var $user     = "aha_fy18"; //database login name
var $pass     = "112U(jkkyr)8"; //database login password
var $database = "zoocrew_fy18"; //database name
