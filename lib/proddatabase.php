...
var $server   = "64.87.24.39"; //database server
var $user     = "kinterat_aha"; //database login name
var $pass     = "Kintera@01"; //database login password
var $database = "kinterat_ahaym_prod"; //database name
