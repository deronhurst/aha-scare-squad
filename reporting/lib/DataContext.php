...
class DataContext {
	...
	function DataContext (){
		...
		$this->Participants = new ContextModel($this->connection, 'participants','Participant');
...
class Fbshare {
	...
	var $Fields = array (
		...
		"message" => array ("Type" => 'text', "Nullable" => true, "Auto" => false, "Length" => 0),
		"supporter_id" => array ("Type" => 'int', "Nullable" => true, "Auto" => false, "Length" => 20),
	...
	// default values array
	var $defaultValues = array("id"=>NULL,"title"=>NULL,"message"=>NULL,"supporter_id"=>NULL,"event_id"=>NULL,"choice"=>NULL,"created"=>NULL);
...
class Participant {
	...
	// validation rules
	var $Fields = array (
		"supporter_id" => array ("Type" => 'int', "Nullable" => false, "Auto" => false, "Length" => 9),
		"first_name" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 50),
		"last_name" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 50),
		"address_city" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 35),
		"address_state" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 3),
		"total_raised" => array ("Type" => 'float', "Nullable" => true, "Auto" => false, "Length" => 10,2),
		"affiliate" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 50),
		"event_id" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 8),
		"event_name" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 100),
		"team_id" => array ("Type" => 'int', "Nullable" => true, "Auto" => false, "Length" => 8),
		"team_name" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 200),
		"school_id" => array ("Type" => 'int', "Nullable" => true, "Auto" => false, "Length" => 8),
		"school_name" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 200),
	        "ecards_sent" => array ("Type" => 'int', "Nullable" => true, "Auto" => false, "Length" => 11),
                "ecards_shared" => array ("Type" => 'int', "Nullable" => true, "Auto" => false, "Length" => 11)
            );

	// default values array
	var $defaultValues = array("supporter_id"=>NULL,"first_name"=>NULL,"last_name"=>NULL,"address_city"=>NULL,"address_state"=>NULL,"total_raised"=>NULL,"affiliate"=>NULL,"event_id"=>NULL,"event_name"=>NULL,"team_id"=>NULL,"team_name"=>NULL,"school_id"=>NULL,"school_name"=>NULL,"ecards_sent"=>NULL,"ecards_shared"=>NULL);
...
class Report {
	...
	/* Parameters required to validate data */
	var $Table = "reports";
	var $Action = "update"; 	// insert | update | delete
	var $PrimaryKey = "id";
	var $Errors;
	// validation rules
	...
	var $Fields = array (		
		...
		"report_id" => array ("Type" => 'bigint', "Nullable" => true, "Auto" => false, "Length" => 20)
...
class Donation {
	...
	var $Fields = array (
		"id" => array ("Type" => 'int', "Nullable" => false, "Auto" => true, "Length" => 10 ),
		"account" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 20),
		"name" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 20),
		...
		"donation" => array ("Type" => 'varchar', "Nullable" => true, "Auto" => false, "Length" => 20),
